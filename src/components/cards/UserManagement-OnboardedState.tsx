...
export  default function UserManagementOnboardedState (){
    return (
        <>
            <div className="empty-state-container users-container">
                ...
                <div className="header-content-container">
                    ...
                    <div className="all-billings-container">
                        ...
                        <div className="billing-empty-state-content bc-sm">
                            <div className="deposit-nondeposit-tab">
                                <div className="search-filter-container billing-search-filter-container sf-sm">
                        ...
                        <div className="parthner-table-conatiner um-table">
                            <div className="parthner-company-row api-company-table api-onboard um-firstname">
                                <div className="parthner-comany-head">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="138aca3d-8574-2c7a-db30-57208c0ee2b3"><label
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="138aca3d-8574-2c7a-db30-57208c0ee2c1"><label
                                            ...
                                            <div className="api-date-created">
                                                <div className="apit-date-txt">Sinclair</div>
                                            </div>
                                        </form>
                                        <div className="w-form-done">
                                            <div>Thank you! Your submission has been received!</div>
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="d0f5149b-1aae-b439-0b97-95d6caebba8f"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="c30b57d7-5f3b-b0e5-ce88-cbf6508f3f90"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="a067eae6-2a5e-d1b6-8576-6ff4a8d53133"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="07653fb2-8177-f098-cb63-4d820d048b10"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="1346a8ca-d615-58a8-0ca5-823b884f93bc"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parther-company-bank">
                                    <div className="w-form">
                                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                              method="get" className="form" data-wf-page-id="66ab6fe73083f6311065ddb8"
                                              data-wf-element-id="8082ddfe-20f4-209c-4336-529d05c167c0"><label
                                            className="w-checkbox checkbox-field-4">
                                            <div
                                                className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                            <input type="checkbox" id="checkbox-3" name="checkbox-3"
