...
export default function MarkerCheckerApproved (){
                            ...
                            <div className="location-container">
                                <div className="location-details-container"><img src= {usersettingsImg}
                                    ...
                                    <div className="approved-box">
                                        <div className="approved-tick"><img src={checkImg} loading="lazy"
                                                                            alt="" className="image-23"/>
                                            <div className="approved-txt">Approved</div>
                                        </div>
                                        <img src={threedots}loading="lazy" alt="" className="image-24"/>
                                    </div>
                                </div>
