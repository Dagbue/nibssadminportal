...
export default function SupportEpmtyState(){
    return (
        <>
            <div className="empty-state-container">
                ...
                <div className="header-content-container">
                    ...
                    {/*    /!*    <div className="dashboard-icon"><img src="../images/Frame-1618868326-3.svg" loading="lazy"*!/*/}
                    {/*    /!*                                         alt=""/></div>*!/*/}
                    ...
                    <div className="all-billings-container">
                        <div className="all-billings-header">
                            <div className="all-header-main-box">
                                <div className="all-billings-text-upper">All Tickets</div>
                                <div className="all-billings-txt-btm">This is a list of all the tickets created by your
                                    partners
                                </div>
                            </div>
                        </div>
                        <div className="billing-empty-state-content">
                            <div className="deposit-nondeposit-tab">
                                <div className="support-all-tickettabs">
                                    <div className="all-tickets-tab">All</div>
                                    <div className="resolved-tickets-tab">Active</div>
                                    <div className="resolved-tkts-tab">Resolved</div>
                                </div>
                                <div className="search-filter-container billing-search-filter-container">
                                    <div className="w-form">
                                        <form id="email-form" name="email-form" data-name="Email Form" method="get"
                                              data-wf-page-id="66a57384dc623da81d0a8523"
                                              data-wf-element-id="a271638b-8ec9-39bc-9f55-8f57dc82fe8e"><input
                            ...
                            <div className="whoops-first-container">
                                <div className="whoops-inner-container">
                                    <div className="empty-state-img-box"><img src= {emptystateImg}
                                                                              loading="lazy" alt=""/></div>
                                    <div className="whoops-txt-container">
                                        <div className="whoops-txt-upper"></div>
                                        <div className="whoop-txt-upper">Whoops.. you&#x27;ve got no Tickets</div>
