...
import addusercircleImg from "../../assets/images/Frame-1618868326-7.svg"
export default function UsersOnboarded (){
    return (
        <>
                ...
                <div className="header-content-container">
                    <div className="dashboard-head">
                        <div className="dashboard-icon-txt-container">
                            <div className="dashboard-icon"><img src={addusercircleImg} loading="lazy"
                                                                 alt=""/></div>
                            <div className="dashboard-txt-container">
                                <div className="dashboard-top-text">Partners</div>
                        ...
                        <div className="bell-add-partner-container"><img src={bellImg} loading="lazy"
                                                                         alt="" className="image-36"/>
                            <div className="green-btn partner-empty-state w-embed">
                                <button
                    ...
                    <div className="all-billings-container">
                        <div className="all-billings-header">
                            <div className="all-partners-txt-container">
                                ...
                                <div className="all-partners-btm-txt hidden">This is a list of all the partners you have
                                    on your account
                                </div>
                            </div>
                        ...
                        <div className="billing-empty-state-content on-board-state">
                            <div className="deposit-nondeposit-tab">
                                <div className="search-filter-container billing-search-filter-container">
                                    ...
                                    <a href="#" className="button-10 btn-10-sm w-button">Filter</a>
                                </div>
                                <div className="all-active-inactive-tabs tabs-sm">
                                    <div className="all-tab-container tab-container-sm">All</div>
                                    <div className="active-tab-container tab-container-sm">Active</div>
                                    <div className="inactive-tab-container tab-container-sm">Inactive</div>
                                </div>
                            </div>
                            <div className="parthner-table-conatiner partner-table-sm">
                                <div className="parthner-company-row users-state">
                                    <div className="parthner-comany-head">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="77d013ba-55fd-cad5-3a6d-ef987dcebe9c"><label
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  ...
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="77d013ba-55fd-cad5-3a6d-ef987dcebeaa"><label
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="fb1120bd-efd6-6d4d-63a0-cb6bb436105a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="0b934b8d-8659-50f7-7e98-cda2cf11db48"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="abb1d572-26c0-0e75-05c2-90f80d5c6796"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="17dec0a9-ac30-b76e-c2d0-c7a29d19dfe9"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="98146f59-e71e-9593-1af3-c922c9f17c6a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank last-column">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66aad361ec22180b891ece2c"
                                                  data-wf-element-id="e38c379d-5152-249e-d240-84bb72252f52"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="type-row-conatiner user-state">
                                    <div className="type-row-header">
                                        <div className="type-txt-box cl-sm">Email</div>
                                        <img src={upanddownimg} loading="lazy" alt=""/>
                                    </div>
                                    <div className="bank-type-box">
                                        <div className="regional-bank-txt">sinclairthompson@mail.com</div>
                                    </div>
                                    <div className="bank-type-box">
                                        <div className="regional-bank-txt">sinclairthompson@mail.com</div>
                                    </div>
                                ...
                                <div className="parthenr-id-row user-state">
                                    <div className="parthner-id-header">
                                        <div className="parthner-id-txt cl-sm">Phone number</div>
                                        <img src={upanddownimg} loading="lazy" alt="" className="image-28"/>
                                    </div>
                                    <div className="id-tst-container">
                                        <div className="text-block">0901234567890</div>
                                    </div>
                                    <div className="id-tst-container">
                                        <div className="text-block">0901234567890</div>
                                    </div>
                                ...
                                <div className="date-created-column user-state">
                                    <div className="date-created-bo">
                                        <div className="text-block-2 cl-sm">Role</div>
                                        <img src={upanddownimg} loading="lazy" alt="" className="image-29"/>
                                    </div>
                                    <div className="date-time-block">
                                        <div className="date-time-txt">Admin</div>
                                    </div>
                                    <div className="date-time-block">
                                        <div className="date-time-txt">Admin</div>
                                    </div>
                                    ...
                                    <div className="date-time-block last-card">
                                        <div className="date-time-txt">Admin</div>
                                    </div>
                                </div>
                                <div className="date-created-column">
                                    <div className="date-created-bo">
                                        <div className="text-block-2 cl-sm">Date Created</div>
                                        <img src={upanddownimg} loading="lazy" alt="" className="image-29"/>
                                    </div>
                                    <div className="date-time-block">
                                ...
                                <div className="status-block">
                                    <div className="status-header-box cl-sm">Status</div>
                                    ...
                                    <div className="status-active-box">
                                        <div className="active-container-box usder-state">
                                            <p className="paragraph-5 user-stae">inactive</p>
                                        </div>
                                    </div>
                                ...
                                <div className="menu-option-row">
                                    ...
                                    <div className="menu-icon-container"><img src={threedots}
                                                                              loading="lazy" alt=""
                                    ...
                                    <div className="menu-icon-container"><img src={threedots}
                                                                              loading="lazy" alt=""
                                                                              className="image-30"/></div>
                                    <div className="menu-icon-container last-menu"><img src={threedots}
                                                                                        loading="lazy" alt=""
                                                                                        className="image-30"/></div>
                                </div>
                            </div>
