                    ...
                    <div className="all-billings-container">
                        <div className="all-billings-header">
                            <div className="all-partners-txt-container">
                                <div className="all-partners-top-txt">United Bank of Africa</div>
                        ...
                        <div className="billing-empty-state-content on-board-state">
                            <div className="deposit-nondeposit-tab active-tab-api">
                            ...
                            <div className="parthner-table-conatiner">
                                <div className="parthner-company-row api-company-table api-onboard">
                                    <div className="parthner-comany-head">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="bd8b19eb-18cd-9018-c9d8-2eb8c5b038a3"><label
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  ...
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="bd8b19eb-18cd-9018-c9d8-2eb8c5b038b1"><label
                                                ...
                                                <div className="api-date-created">
                                                    <div className="apit-date-txt">Jan 3,2023</div>
                                                    <div className="api-time">10:30 PM</div>
                                                </div>
                                            </form>
                                            <div className="w-form-done">
                                                <div>Thank you! Your submission has been received!</div>
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="7ff8cbed-d7ae-916b-dd77-38096a33e60c"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="9951adfb-98b9-7502-1265-cb7b10cfa5ef"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="954f4276-9ac5-6533-65fd-0911b85a1e20"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="30544644-b928-2110-2b10-9d531d0cc952"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="a3094e9a-eec5-cc2a-dbc0-ab7ff5f3187e"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank last-column">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66ab5c42e30229efdd68f62d"
                                                  data-wf-element-id="36018da7-782a-fb17-8625-e51b34ad5f98"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                ...
                                <div className="parthenr-id-row active-api-table onboard-description">
                                    <div className="parthner-id-header active-api-header">
                                        <div className="parthner-id-txt">Description</div>
                                        <img src="../images/Frame-5-1.svg" loading="lazy" alt="" className="image-28"/>
                                    </div>
                                    <div className="id-tst-container">
                                        <div className="text-block description-api">This fetches all the list of banks
                                            available
                                        </div>
                                    </div>
                                    <div className="id-tst-container">
                                ...
                                <div className="date-created-column update-api-table method-api">
                                    <div className="date-created-bo">
                                        <div className="text-block-2">Method</div>
                                        <img src="../images/Frame-5-1.svg" loading="lazy" alt="" className="image-29"/>
                                    </div>
                                    <div className="date-time-block">
                                        <div className="date-time-txt post-api">POST</div>
                                    </div>
                                    <div className="date-time-block">
                                        <div className="date-time-txt post-api get-api">GET</div>
                                    </div>
                                    <div className="date-time-block">
                                        <div className="date-time-txt post-api">POST</div>
                                    </div>
                                ...
                                <div className="menu-option-row api-menu">
                                    <div className="menu-header"></div>
                                    <div className="menu-icon-container api-menu-1mg"><img src="../images/Dropdown.svg"
                                                                                           loading="lazy" alt=""
                                    ...
                                    <div className="menu-icon-container api-menu-1mg"><img src="../images/Dropdown.svg"
                                                                                           loading="lazy" alt=""
                                                                                           className="image-30"/></div>
                                    <div className="menu-icon-container api-menu-1mg last-column"><img
                                        src="../images/Dropdown.svg" loading="lazy" alt="" className="image-30"/></div>
                                </div>
                            </div>
                        </div>
