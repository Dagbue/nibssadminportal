                ...
                <div className="header-content-container">
                    <div className="dashboard-head">
                        <div className="dashboard-icon-txt-container">
                            <div className="dashboard-icon"><img src="../images/Frame-1618868326-5.svg" loading="lazy"
                                                                 alt=""/></div>
                            <div className="dashboard-txt-container">
                                <div className="dashboard-top-text">Account Settings</div>
                                <div className="dashboard-btm-txt">Manage all settings for your account</div>
                            </div>
                        </div>
                    ...
                    <div className="profile-activity-notification-tab">
                        <div className="my-profile-tab">My Profile</div>
                        <div className="activity-tab-settings">Activity</div>
                        <div className="notification-tab-settings">Notifications</div>
                    </div>
                    <div className="logged-in-device-container">
                        <div className="logged-in-device-header">
                            <div className="loggedin-device-inner-header">
                                <div className="loggedin-top-txt">Where you’re logged in</div>
                                <div className="loggedin-btm-txt">We’ll alert you via<strong> seun@qucoon.com </strong>if
                                    there is any unusual activity on your account.
                                </div>
                            </div>
                            <img src="../images/Dropdown.svg" loading="lazy" alt="" className="image-18"/>
                        </div>
                        <div className="device-location-container">
                            <div className="device-colomn"><img src="../images/monitor-04.svg" loading="lazy" alt=""
                                                                className="image-19"/>
                                <div className="device-location-model">
                                    <div className="device-name-activity">
                                        <div className="device-name-model">2018 Macbook Pro 15-inch</div>
                                        <div className="activity-status">
                                            <div className="active-now-box">Active now</div>
                                            <div className="green-dot-icon"><img src="../images/_Dot.svg" loading="lazy"
                                                                                 alt=""/></div>
                                        </div>
                                    </div>
                                    <div className="device-location-txt">Lagos, Nigeria • 22 Jan at 10:40am</div>
                                </div>
                            </div>
