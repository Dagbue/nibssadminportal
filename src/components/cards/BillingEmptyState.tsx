        ...
        <>
            <div className="empty-state-container">
                ...
                <div className="header-content-container">
                    ...
                    {/*        <div className="dashboard-icon"><img src = {userIcon} loading="lazy"*/}
                    {/*                                             alt=""/></div>*/}
                    ...
                    <div className="all-billings-container">
                        <div className="all-billings-header">
                            <div className="all-header-main-box">
                                <div className="all-billings-text-upper">All Billings</div>
                                <div className="all-billings-txt-btm">This is a list of all the billing for your
                                    partners
                                </div>
                            </div>
                        </div>
                        <div className="billing-empty-state-content">
                            <div className="deposit-nondeposit-tab billing-tab-container">
                                <div className="deposit-nondeposit-tab-split">
                                    <div className="deposit-tab">Deposit Money Banks</div>
                                    <div className="deposit-tab">Non-Deposit Money Banks</div>
                                </div>
                            ...
                            <div className="whoops-first-container">
                                <div className="whoops-inner-container">
                                    ...
                                    <div className="whoops-txt-container">
                                        ...
                                        <div className="whoop-txt-upper">Whoops.. you&#x27;ve got no Billings</div>
