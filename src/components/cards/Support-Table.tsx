                ...
                <div className="header-content-container">
                    ...
                    <div className="all-billings-container">
                        <div className="all-billings-header">
                            ...
                            <div className="filter-tab"><img src= {uploadImg} loading="lazy" alt=""
                                                             className="image-15"/>
                        ...
                        <div className="parthener-billin-content-container">
                            ...
                            <div className="table-content-container">
                                <div className="institution-name-container support-tickets">
                                    <div className="institution-name-header">
                                        <div className="institution-name-txt header-institution">Tickets Created</div>
                                        <img src={upanddownimg} loading="lazy" alt=""/>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">30</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">12</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">54</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">11</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">29</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">42</div>
                                    </div>
                                    <div className="institution-icon-bank-box last-status">
                                        <div className="institution-inner-icon-bnk">14</div>
                                    </div>
                                </div>
                                <div className="institution-name-container support-tickets-resolved">
                                    <div className="institution-name-header">
                                        <div className="institution-name-txt header-institution">Tickets Resolved</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">24</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">12</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">32</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">10</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">40</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">40</div>
                                    </div>
                                ...
                                <div className="institution-name-container open-tickets support-open-tickets">
                                    <div className="institution-name-header">
                                        <div className="institution-name-txt header-institution">Open Tickets</div>
                                        <img src={upanddownimg} loading="lazy" alt=""/>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">6</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">0</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">22</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">1</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">0</div>
                                    </div>
                                    <div className="institution-icon-bank-box">
                                        <div className="institution-inner-icon-bnk">2</div>
                                    </div>
                                    <div className="institution-icon-bank-box last-status">
                                        <div className="institution-inner-icon-bnk">4</div>
                                    </div>
                                </div>
                                <div className="institution-name-container support-date-container">
                                    <div className="institution-name-header">
                                        <div className="institution-name-txt header-institution">Date Created</div>
                                        <img src={upanddownimg} loading="lazy" alt=""/>
                                    </div>
                                    <div className="institution-icon-bank-box date-created-billing">
                                        <div className="date-created-inner-box">
                                            <div className="date-created-upper-txt">Jan 3,2023</div>
                                            <div className="date-created-lower-txt">10:30 PM</div>
                                        </div>
                                    </div>
                                    <div className="institution-icon-bank-box date-created-billing">
                                        <div className="date-created-inner-box">
                                    ...
                                    <div className="institution-icon-bank-box date-created-billing last-status">
                                        <div className="date-created-inner-box">
                                            <div className="date-created-upper-txt">Jan 3,2023</div>
                                            <div className="date-created-lower-txt">10:30 PM</div>
                                        </div>
                                ...
                                <div className="institution-id-container status">
                                    <div className="institution-id-header"></div>
                                    <div className="institution-id-num-box status-color">
                                        <div className="status-successful">View Tickets</div>
                                    </div>
                                    <div className="institution-id-num-box status-color">
                                        <div className="status-successful">View Tickets</div>
                                    </div>
                                    ...
                                    <div className="institution-id-num-box status-color last-status">
                                        <div className="status-successful">View Tickets</div>
                                    </div>
                                </div>
                                    ...
                                    <div className="parthner-comany-head">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e21dc"><label
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  ...
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e21ea"><label
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e21fa"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e220a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e221a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e222a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e223a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
                                    ...
                                    <div className="parther-company-bank last-column">
                                        <div className="w-form">
                                            <form id="email-form-2" name="email-form-2" data-name="Email Form 2"
                                                  method="get" className="form"
                                                  data-wf-page-id="66a5790e8253ff8176321ccc"
                                                  data-wf-element-id="bb9ac19f-d6ae-8710-7c5e-19aa849e224a"><label
                                                className="w-checkbox checkbox-field-4">
                                                <div
                                                    className="w-checkbox-input w-checkbox-input--inputType-custom checkbox-3 company-parthner-bank-checkbox"></div>
                                                <input type="checkbox" id="checkbox-3" name="checkbox-3"
